...
* (propagation) Added a virtual base class `WraparoundModel` for wraparound models.
* (propagation) Added the `HexagonalWraparoundModel` class with the wraparound implementation for hexagonal cell deployments with 0, 1 or 3 rings.
