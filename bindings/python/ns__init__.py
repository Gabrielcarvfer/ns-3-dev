...
def find_ns3_from_lock_file(lock_file: str) -> (str, list, list, str):
    ...
    return prefix, modules, libraries_to_load, version
...
def find_ns3_from_search() -> (str, list, list, str):
    ...
    libraries, version = filter_in_newest_ns3_libraries(libraries, modules)
    return prefix, modules, libraries, version
...
def load_modules():
    ...
    prefix, modules, libraries, version = ret
