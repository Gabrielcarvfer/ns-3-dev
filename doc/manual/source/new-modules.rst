...
.. sourcecode:: cmake
  ...
  set(source_files helper/new-module-helper.cc model/new-module.cc)
  
  set(header_files helper/new-module-helper.h model/new-module.h)

  set(libraries_to_link ${libcore})

  set(test_sources test/new-module-test-suite.cc)
...
.. sourcecode:: cmake
    ...
    set(libraries_to_link ${libinternet} ${libmobility} ${libaodv})
...
.. sourcecode:: cmake
  ...
  set(name new-module-example)
  set(source_files ${name}.cc new-module-example-part.cc)
  set(header_files)
  set(libraries_to_link ${libspectrum} ${libmobility} ${libinternet}
                        ${libapplications}
  )
