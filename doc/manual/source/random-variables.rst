...
variables at the time of their instantiation. However, relying on a specific
automatically assigned stream number may lead to unexpected failures,
...
.. sourcecode:: console
  ...
  Automatic variable stream: ns3::UniformRandomVariable, instantiated in:
     0# ns3::RandomVariableStream::SetStream(long) at /ns-3-dev/src/core/model/random-variable-stream.cc:139
     1# ns3::DoMakeAccessorHelperTwo<ns3::IntegerValue, ns3::RandomVariableStream, long, long>(void (ns3::RandomVariableStream::*)(long), long (ns3::RandomVariableStream::*)() const)::MemberMethod::DoSet(ns3::RandomVariableStream*, ns3::IntegerValue const*) const at /ns-3-dev/src/core/model/attribute-accessor-helper.h:461
     2# ns3::AccessorHelper<ns3::RandomVariableStream, ns3::IntegerValue>::Set(ns3::ObjectBase*, ns3::AttributeValue const&) const at /ns-3-dev/src/core/model/attribute-accessor-helper.h:171
     3# ns3::ObjectBase::DoSet(ns3::Ptr<ns3::AttributeAccessor const>, ns3::Ptr<ns3::AttributeChecker const>, ns3::AttributeValue const&) at /ns-3-dev/src/core/model/object-base.cc:207
     4# ns3::ObjectBase::ConstructSelf(ns3::AttributeConstructionList const&) at /ns-3-dev/src/core/model/object-base.cc:159
     5# ns3::Object::Construct(ns3::AttributeConstructionList const&) at /ns-3-dev/src/core/model/object.cc:149
     6# ns3::ObjectFactory::Create() const at /ns-3-dev/src/core/model/object-factory.cc:93
     7# ns3::Ptr<ns3::Object> ns3::ObjectFactory::Create<ns3::Object>() const at /ns-3-dev/src/core/model/object-factory.h:196
     8# ns3::PointerValue::DeserializeFromString(std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >, ns3::Ptr<ns3::AttributeChecker const>) at /ns-3-dev/src/core/model/pointer.cc:83
     9# ns3::AttributeChecker::CreateValidValue(ns3::AttributeValue const&) const at /ns-3-dev/src/core/model/attribute.cc:68
    10# ns3::ObjectBase::DoSet(ns3::Ptr<ns3::AttributeAccessor const>, ns3::Ptr<ns3::AttributeChecker const>, ns3::AttributeValue const&) at /ns-3-dev/src/core/model/object-base.cc:202
    11# ns3::ObjectBase::ConstructSelf(ns3::AttributeConstructionList const&) at /ns-3-dev/src/core/model/object-base.cc:159
    12# ns3::Object::Construct(ns3::AttributeConstructionList const&) at /ns-3-dev/src/core/model/object.cc:149
    13# ns3::Ptr<ns3::RateErrorModel> ns3::CompleteConstruct<ns3::RateErrorModel>(ns3::RateErrorModel*) at /ns-3-dev/src/core/model/object.h:602
    14# ns3::Ptr<ns3::RateErrorModel> ns3::CreateObject<ns3::RateErrorModel>() at /ns-3-dev/src/core/model/object.h:621
    15# ThreeGppHttpObjectTestCase::ThreeGppHttpObjectTestCase(std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > const&, unsigned int, ns3::TypeId const&, ns3::Time const&, double, unsigned int, bool, std::optional<unsigned short>) at /ns-3-dev/src/applications/test/three-gpp-http-client-server-test.cc:336
    16# ThreeGppHttpClientServerTestSuite::AddHttpObjectTestCase(unsigned int, ns3::Time const&, double, unsigned int, bool, std::optional<unsigned short>) at /ns-3-dev/src/applications/test/three-gpp-http-client-server-test.cc:997
    17# ThreeGppHttpClientServerTestSuite::ThreeGppHttpClientServerTestSuite() at /ns-3-dev/src/applications/test/three-gpp-http-client-server-test.cc:914
    18# __static_initialization_and_destruction_0 at /ns-3-dev/src/applications/test/three-gpp-http-client-server-test.cc:1004
    19# _GLOBAL__sub_I_three_gpp_http_client_server_test.cc at /ns-3-dev/src/applications/test/three-gpp-http-client-server-test.cc:1004
    20# call_init at ./elf/dl-init.c:74
    21# call_init at ./elf/dl-init.c:120
    22#      at ./elf/rtld.c:2305
  
  aborted. msg="NS_CHECK_AUTOMATIC_STREAMS: 117 automatic variable streams", +10001.000000000s -1 file=/ns-3-dev/src/core/model/random-variable-stream.cc, line=184
  NS_FATAL, terminating
     0# ns3::RandomVariableStream::CheckAutomaticStreams() at /ns-3-dev/src/core/model/random-variable-stream.cc:184
     1# ns3::Simulator::Stop() at /ns-3-dev/src/core/model/simulator.cc:186
     2# ns3::MakeEvent<>(void (*)())::EventFunctionImpl::Notify()::{lambda()#1}::operator()() const at /ns-3-dev/src/core/model/make-event.h:183
     3# void std::__invoke_impl<void, ns3::MakeEvent<>(void (*)())::EventFunctionImpl::Notify()::{lambda()#1}>(std::__invoke_other, ns3::MakeEvent<>(void (*)())::EventFunctionImpl::Notify()::{lambda()#1}&&) at /usr/include/c++/14/bits/invoke.h:61
     4# std::__invoke_result<ns3::MakeEvent<>(void (*)())::EventFunctionImpl::Notify()::{lambda()#1}>::type std::__invoke<ns3::MakeEvent<>(void (*)())::EventFunctionImpl::Notify()::{lambda()#1}>(ns3::MakeEvent<>(void (*)())::EventFunctionImpl::Notify()::{lambda()#1}&&) at /usr/include/c++/14/bits/invoke.h:96
     5# decltype(auto) std::__apply_impl<ns3::MakeEvent<>(void (*)())::EventFunctionImpl::Notify()::{lambda()#1}, std::tuple<>&>(ns3::MakeEvent<>(void (*)())::EventFunctionImpl::Notify()::{lambda()#1}&&, std::tuple<>&, std::integer_sequence<unsigned long>) at /usr/include/c++/14/tuple:2923
     6# _ZSt5applyIZZN3ns39MakeEventIJEJEEEPNS0_9EventImplEPFvDpT_EDpT0_EN17EventFunctionImpl6NotifyEvEUlvE_TkSt12__tuple_likeRSt5tupleIJEEEDcOT_OT0_ at /usr/include/c++/14/tuple:2938
     7# ns3::MakeEvent<>(void (*)())::EventFunctionImpl::Notify() at /ns-3-dev/src/core/model/make-event.h:183
     8# ns3::EventImpl::Invoke() at /ns-3-dev/src/core/model/event-impl.cc:41
     9# ns3::DefaultSimulatorImpl::ProcessOneEvent() at /ns-3-dev/src/core/model/default-simulator-impl.cc:133
    10# ns3::DefaultSimulatorImpl::Run() at /ns-3-dev/src/core/model/default-simulator-impl.cc:186
    11# ns3::Simulator::Run() at /ns-3-dev/src/core/model/simulator.cc:173
    12# OutdoorRandomWalkTestCase::DoRun() at /ns-3-dev/src/buildings/test/outdoor-random-walk-test.cc:149
    13# ns3::TestCase::Run(ns3::TestRunnerImpl*) at /ns-3-dev/src/core/model/test.cc:359
    14# ns3::TestCase::Run(ns3::TestRunnerImpl*) at /ns-3-dev/src/core/model/test.cc:353
    15# ns3::TestRunnerImpl::Run(int, char**) at /ns-3-dev/src/core/model/test.cc:1149
    16# ns3::TestRunner::Run(int, char**) at /ns-3-dev/src/core/model/test.cc:1173
    17# main at /ns-3-dev/utils/test-runner.cc:12
    18# __libc_start_call_main at ../sysdeps/nptl/libc_start_call_main.h:58
    19# __libc_start_main_impl at ../csu/libc-start.c:360
    20# _start at :0
    21# 
  
  terminate called without an active exception
  Command 'build/utils/ns3-dev-test-runner-debug --test-name=outdoor-random-walk-model' died with <Signals.SIGABRT: 6>.

From that we can see that 117 automatically assigned streams exist for this program (``test-runner``).
...
The limitation of this instrumentation should be obvious now: if the streams are assigned during runtime, but you do
not execute a particular test that performs that assignation, the stream will be considered automatically assigned,
even though it may not interfere with the results. For simulation programs, that should not be an issue, but for
tests, the recommended way to handle this is by setting the CMake variable ``NS3_FILTER_MODULE_EXAMPLES_AND_TESTS``
to the module being worked on and tested. This should remove the majority of false positives.
