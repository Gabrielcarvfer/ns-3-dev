...
class TcpL4Protocol : public IpL4Protocol
{
  ...
  private:
    ...
    uint32_t m_isnSecret{0};         //!< Secret used to generate the initial sequence numbers
    bool m_isnSecretDrawn{false};    //!< True once the ISN secret has been drawn
