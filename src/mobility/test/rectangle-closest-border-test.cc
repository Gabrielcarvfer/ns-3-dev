 ...
 * Copyright (c) 2023 Universidade de Brasília (UnB)
 *
...
class RectangleClosestBorderTestCase : public TestCase
{
  ...
  private:
    ...
    Rectangle::Side m_side{ns3::Rectangle::TOPSIDE}; /**< Flag to indicate the intersection.
...
static RectangleClosestBorderTestSuite
    rectangleClosestBorderTestSuite; //!< rectangleClosestBorderTestSuite
...
const std::array<char[20], 8> g_sideLabels = {
    "RIGHTSIDE",
    "LEFTSIDE",
    "TOPSIDE",
    "BOTTOMSIDE",
                                                ...
                                                Rectangle::Side side)
{
    ...
    oss << "Rectangle closest border test : checking"
        ...
        << ", " << rectangle.xMax << ", " << rectangle.yMin << ", " << rectangle.yMax
        << "). The expected side = " << g_sideLabels[side] << "  ";
    return oss.str();
}
