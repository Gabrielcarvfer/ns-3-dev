...
The ns-3 implementation wraparound provides the generic base class interface `WraparoundModel`, and it provides the specialization for the
typical hexagonal deployments implemented in `HexagonalWraparoundModel`. `HexagonalWraparoundModel` generates the virtual position of a node in
