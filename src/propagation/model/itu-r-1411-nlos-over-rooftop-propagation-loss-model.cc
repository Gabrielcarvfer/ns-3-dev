                                                     ...
                                                     Ptr<MobilityModel> b) const
{
    ...
    {
        // ITU-R P.1411 eq. (13) for 55 <= phi <= 90 (issue #1164)
    ...
    if (ds < m_buildingsExtend)
    {
        ...
        else
        {
            ...
            // rooftop height, not the height of one of the terminals (issue #1164)
        ...
        else if ((m_environment == UrbanEnvironment) && (m_citySize == LargeCity))
        {
            ...
            // suburban centres use 0.7. The two coefficients were swapped (issue #1164)
