...
#
# Plot the traces generated by three-gpp-spatiotemporal-channel-consistency-example
#

# -----------------------------------------------------------------------------
# Load data
# -----------------------------------------------------------------------------
df = pd.read_csv("3gpp-spatiotemporal-channel-consistency-output.txt", sep=r"\s+", comment="#")
...
buildings = pd.read_csv(
    "3gpp-spatiotemporal-channel-consistency-buildings.txt", sep=r"\s+", comment="#", header=None
)
...
fig_snr.savefig("spatiotemporal_channel_consistency_snr_and_dsnr.png", dpi=300, bbox_inches="tight")
plt.close(fig_snr)
...
ani.save("3gpp-spatiotemporal-channel-consistency.gif", writer="pillow", fps=25, dpi=90)
