    ...
    bool isReverse) const
{
    ...
    // Precompute the delay until numRb or numCluster changes
    // Whenever the channelParams are updated, the number of numRbs and numClusters
    // is reset to ensure these values are updated too
