...
class TestSimulator(unittest.TestCase):
    ...
    def testCommandLine(self):
        ...
        test4 = c_char_p(create_string_buffer(b"this is a test option", 4096).raw)
        ...
        cmd.AddValue("Test4", "this is a test option", test4)
        ...
        cmd.Parse(["python", "--Test4=try_to_purposely_cause_a_buffer_overflow_with_a_very_large_string"])
        self.assertEqual(test4.value, b"try_to_purposely_cause_a_buffer_overflow_with_a_very_large_string")
