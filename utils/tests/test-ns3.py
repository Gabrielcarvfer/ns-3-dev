...
class DockerContainerManager:
    ...
    def __init__(self, currentTestCase: unittest.TestCase, containerName: str = "ubuntu:latest"):
        ...
        try:
            ...
            currentTestCase.skipTest("python-on-whales returned:", e.__str__())
...
class NS3QualityControlTestCase(unittest.TestCase):
    ...
    def test_01_MemoryCheckWithSanitizers(self):
        """!
    ...
    def test_02_CheckImageBrightness(self):
        """!
    ...
    def test_03_CheckForBrokenLogs(self):
        """!
